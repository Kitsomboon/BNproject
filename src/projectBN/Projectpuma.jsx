...
import image1 from "/src/assets/puma.png";
import Footer from "../components/Footer";
import Footer2 from "../componentsindex/Footer2";

function Projectpuma() {
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom, rgb(8, 189, 255), rgba(84, 236, 247, 0.9)), url(${image1})`,
      ...
      >
        ...
        <div className="absolute inset-0 bg-black bg-opacity-30 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <h1 className="text-xl md:text-5xl font-bold mb-2">{title}</h1>
