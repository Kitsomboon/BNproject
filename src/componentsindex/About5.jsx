    ...
    <section className="flex flex-col md:flex-row items-center justify-center bg-white py-20 md:py-32 px-10 md:px-12">
      ...
      >
        ...
        <p className="text-black mb-10  md:text-left  ">
          บริษัท บี.เอ็น. โซล่าร์ เพาเวอร์ จำกัด (B.N. SOLAR POWER) เริ่มดำเนินกิจการ ตั้งแต่ปี 2557 (2014)
          โดยการก่อตั้งของ ดร.สุชัจจ์ ศรีแก้ว และเริ่มต้นดำเนินด้านการออกแบบและควบคุมงานติดตั้งระบบผลิตไฟฟ้าด้วยเซลล์
          แสงอาทิตย์ และด้านการศึกษาและวิเคราะห์ด้านเศรษฐศาสตร์และสิ่งแวดล้อมให้กับหน่วยงานภาพรัฐและภาคเอกชน
        </p>
      </div>
